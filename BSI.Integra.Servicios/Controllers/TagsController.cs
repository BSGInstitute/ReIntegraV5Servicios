...
namespace BSI.Integra.Servicios.Controllers
{
    ...
    public class TagsController : Controller
    {
        ...
        public IActionResult Insertar([FromBody] TagsEnvio entidad)
        {
            ...
            try
            {
                var servicio = new TagsService(unitOfWork);
        ...
        /// Versión: 1.0
        /// <summary>
        /// Obtiene todos los registros guardados en T_Tags para combo.
        /// </summary>
        ...
        /// Versión: 1.0
        /// <summary>
        /// Obtiene todos los registros guardados en T_Tags
        /// </summary>
        /// <returns> List<TagsDTO> </returns>
        [HttpGet("[Action]")]
        public IActionResult ObtenerTags()
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
            ...
            {
                var servicio = new TagsService(unitOfWork);
                return Ok(servicio.ObtenerTags());
            }
            catch (Exception ex)
            {
                return BadRequest(ex.Message);

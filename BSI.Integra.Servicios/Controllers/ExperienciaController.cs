...
namespace BSI.Integra.Servicios.Controllers
{
    ...
    public class ExperienciaController : ControllerBase
    {
        ...
        public ExperienciaController(IUnitOfWork unitOfWork)
        {
        ...
        [HttpPost("Insertar")]
        public IActionResult Insertar([FromBody] ExperienciaRecibidoDTO entidad)
        {
            ...
            if (_respuestaCorrecta.TokenValida)
            {
                ...
                try
                {
                    var servicio = new ExperienciaService(unitOfWork);
        ...
        public IActionResult InsertarLista([FromBody] List<Experiencia> listado)
        {
            var claimsIdentity = User.Identity as ClaimsIdentity;
            var _respuestaCorrecta = ValidacionClaim.ValidarClaimFechaExpiracion(claimsIdentity);
        ...
        [HttpPut("Actualizar")]
        public IActionResult Actualizar([FromBody] ExperienciaRecibidoDTO entidad)
        {
            var claimsIdentity = User.Identity as ClaimsIdentity;
            var _respuestaCorrecta = ValidacionClaim.ValidarClaimFechaExpiracion(claimsIdentity);
        ...
        public IActionResult ActualizarLista([FromBody] List<Experiencia> listado)
        {
            var claimsIdentity = User.Identity as ClaimsIdentity;
            var _respuestaCorrecta = ValidacionClaim.ValidarClaimFechaExpiracion(claimsIdentity);
        ...
        /// Versión: 1.0
        /// <summary>
        /// Obtiene todos los registros guardados en T_Experiencia para combo.
        /// </summary>

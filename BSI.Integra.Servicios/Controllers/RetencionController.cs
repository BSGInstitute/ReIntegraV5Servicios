...
namespace BSI.Integra.Servicios.Controllers
{
    ...
    public class RetencionController : ControllerBase
    {
        ...
        public RetencionController(IUnitOfWork unitOfWork)
        {
        ...
        [HttpPost("Insertar")]
        public IActionResult Insertar([FromBody] RetencionRecibidoDTO entidad)
        {
            ...
            if (_respuestaCorrecta.TokenValida)
            {
                ...
                try
                {
                    var servicio = new RetencionService(unitOfWork);
        ...
        public IActionResult InsertarLista([FromBody] List<Retencion> listado)
        {
            var claimsIdentity = User.Identity as ClaimsIdentity;
            var _respuestaCorrecta = ValidacionClaim.ValidarClaimFechaExpiracion(claimsIdentity);
        ...
        [HttpPut("Actualizar")]
        public IActionResult Actualizar([FromBody] RetencionRecibidoDTO entidad)
        {
            var claimsIdentity = User.Identity as ClaimsIdentity;
            var _respuestaCorrecta = ValidacionClaim.ValidarClaimFechaExpiracion(claimsIdentity);
        ...
        public IActionResult ActualizarLista([FromBody] List<Retencion> listado)
        {
            var claimsIdentity = User.Identity as ClaimsIdentity;
            var _respuestaCorrecta = ValidacionClaim.ValidarClaimFechaExpiracion(claimsIdentity);
        ...
        /// Versión: 1.0
        /// <summary>
        /// Obtiene todos los registros guardados en T_Retencion
        /// </summary>
        /// <returns> Retorna 200 y lista de objetos o 400 y mensaje de error </returns>
        [HttpGet("ObtenerRetencion")]
        public IActionResult ObtenerRetencion()
        {
            var claimsIdentity = User.Identity as ClaimsIdentity;
            var _respuestaCorrecta = ValidacionClaim.ValidarClaimFechaExpiracion(claimsIdentity);
            ...
            if (_respuestaCorrecta.TokenValida)
            {
                ...
                {
                    var servicio = new RetencionService(unitOfWork);
                    return Ok(servicio.ObtenerRetencion());
                }
                catch (Exception ex)
                {
                    return BadRequest(ex.Message);
        ...
        /// Versión: 1.0
        /// <summary>
        /// Obtiene todos los registros guardados en T_Retencion para combo.
        /// </summary>

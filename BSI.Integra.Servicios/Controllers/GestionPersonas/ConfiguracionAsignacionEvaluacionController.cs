...
namespace BSI.Integra.Servicios.Controllers.GestionPersonas
{
    ...
    public class ConfiguracionAsignacionEvaluacionController : ControllerBase
    {
        private ITokenManager _tokenManager;
        private IConfiguracionAsignacionEvaluacionService _examenAsignadoEvaluadorService;
        public ConfiguracionAsignacionEvaluacionController(IUnitOfWork unitOfWork, ITokenManager tokenManager)
        {

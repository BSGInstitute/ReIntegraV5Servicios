...
;
        ...
        /// Version: 1.0
        /// <summary>
        /// Actualiza el valor de asingacionPais para asesor en asignación regular
        /// </summary>
        /// <returns>bool</returns>
        public bool? ActualizarAsignacionPaisAsesor(ActualizarAsignacionPaisAsesorDTO request, string usuarioModificacion)
        {
            try
            {
                bool? RespuestaBool = new bool();
                RespuestaBool = _unitOfWork.AsignacionRegularRepository.ActualizarAsignacionPaisAsesor(request.IdAsignacionRegular, request.AsignacionPais, usuarioModificacion);
                return RespuestaBool;
            }
            catch (Exception ex)
            {
        ...
        public ObtenerAsignacionPaisAsesorDTO ObtenerAsignacionPaisAsesor(int idAsignacionRegular)
        {
            try
            {
                return _unitOfWork.AsignacionRegularRepository.ObtenerAsignacionPaisAsesor(idAsignacionRegular);
            }
            catch (Exception ex)
            {
                throw ex;

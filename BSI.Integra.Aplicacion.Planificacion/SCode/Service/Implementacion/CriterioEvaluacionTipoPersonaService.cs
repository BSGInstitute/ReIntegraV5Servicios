...
{
    /// Service: CriterioEvaluacionTipoPersonaService
    /// Autor: Gilmer Quispe.
    /// Fecha: 01/06/2023
    /// <summary>
    /// Gestión general de T_CriterioEvaluacionTipoPersona
    /// </summary>
    public class CriterioEvaluacionTipoPersonaService : ICriterioEvaluacionTipoPersonaService
    {
        private IUnitOfWork _unitOfWork;
        private Mapper _mapper;
        public CriterioEvaluacionTipoPersonaService(IUnitOfWork unitOfWork)
        {
        ...
        /// Version: 1.0
        /// <summary>
        /// Realiza una eliminacion logica en la tabla T_CriterioEvaluacionTipoPersona
        /// </summary>
        ...
        public bool EliminacionLogicaPorCriterioEvaluacion(int idCriterioEvaluacion, string usuario, List<int> idsCriterioEvaluacionTipoProgramaNuevos)
        {
            try
            {
                ...
                var criterioEvaluacionTipoProgramas = _unitOfWork.CriterioEvaluacionTipoPersonaRepository.ObtenerPorIdCriterioEvaluacion(idCriterioEvaluacion);
                listaBorrar = criterioEvaluacionTipoProgramas.Select(x => x.IdTipoPersona).ToList();
                listaBorrar.RemoveAll(x => idsCriterioEvaluacionTipoProgramaNuevos.Any(y => y == x));

                var resultado = _unitOfWork.CriterioEvaluacionTipoPersonaRepository.Delete(listaBorrar, usuario);
                _unitOfWork.Commit();
                return resultado;
            }
            catch (Exception e)

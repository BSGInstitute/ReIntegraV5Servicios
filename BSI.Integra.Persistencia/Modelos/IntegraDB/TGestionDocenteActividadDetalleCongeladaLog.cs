...
{
    /// <summary>
    /// Log de cambios en actividades detalle congeladas. Rastrea transiciones de estado.
    /// </summary>
    public partial class TGestionDocenteActividadDetalleCongeladaLog
    {
        /// <summary>
        ...
        /// <summary>
        /// Identificador de la actividad detalle congelada. Clave foránea a T_GestionDocenteActividadDetalleCongelada.
        /// </summary>
        public int IdGestionDocenteActividadDetalleCongelada { get; set; }
        /// <summary>
        /// Identificador del estado anterior. NULLABLE. Puede ser nulo.
        /// </summary>

...
namespace BSI.Integra.Persistencia.Modelos.IntegraDB
{
    public partial class TAsignacionOportunidad
    {
        ...
        {
            TAsignacionOportunidadLogs = new HashSet<TAsignacionOportunidadLog>();
        }
        ...
        /// <summary>
        /// Fecha de asignacion del registro
        /// </summary>
        ...
        public virtual ICollection<TAsignacionOportunidadLog> TAsignacionOportunidadLogs { get; set; }
    }
}

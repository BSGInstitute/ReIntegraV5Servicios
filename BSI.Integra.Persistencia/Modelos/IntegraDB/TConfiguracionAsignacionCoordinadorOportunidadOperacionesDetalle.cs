...
namespace BSI.Integra.Persistencia.Modelos.IntegraDB
{
    public partial class TConfiguracionAsignacionCoordinadorOportunidadOperacionesDetalle
    {
        ...
        /// <summary>
        /// FK de la tabla T_ConfiguracionAsignacionCoordinadorOportunidadOperaciones
        /// </summary>
        public int IdConfiguracionAsignacionCoordinadorOportunidadOperaciones { get; set; }
        /// <summary>
        /// FK  de la tabla T_ModalidadCurso
        /// </summary>
        public int IdModalidadCurso { get; set; }
        /// <summary>
        /// FK de la tabla T_Pais
        /// </summary>

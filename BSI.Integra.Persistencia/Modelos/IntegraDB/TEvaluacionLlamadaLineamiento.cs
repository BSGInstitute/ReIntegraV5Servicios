...
{
    /// <summary>
    /// Lineamientos de evaluación. Almacena IdPersonalAreaTrabajo e IdConfiguracionVersion. NULL en versión = editable, NOT NULL = congelado.
    /// </summary>
    public partial class TEvaluacionLlamadaLineamiento
    {
        /// <summary>
        ...
        /// </summary>
        public int IdEvaluacionLlamadaCriterio { get; set; }
        /// <summary>
        /// Identificador de la criticidad asociada al lineamiento
        /// </summary>
        public int IdEvaluacionLlamadaCriticidad { get; set; }
        /// <summary>
        /// Nombre del lineamiento de evaluación
        /// </summary>
        public string NombreLineamiento { get; set; } = null!;
        /// <summary>
        /// Orden de presentación del lineamiento
        /// </summary>
        ...
        public virtual TEvaluacionLlamadaCriterio IdEvaluacionLlamadaCriterioNavigation { get; set; } = null!;
        public virtual TEvaluacionLlamadaCriticidad IdEvaluacionLlamadaCriticidadNavigation { get; set; } = null!;

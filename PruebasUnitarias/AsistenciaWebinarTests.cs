...
{
    [TestClass]
    public sealed class AsistenciaWebinarTests
    {
        ...
        //[TestMethod]
        //public void AsistenciaWebinar_CuandoTodoEsValido_RetornarTrue()
        //{
        //    var matriculaRepoMock = new Mock<IMatriculaCabeceraRepository>();
        //    var sesionRepoMock = new Mock<IPEspecificoSesionRepository>();
        //    var confirmacionRepoMock = new Mock<IConfirmacionWebinarRepository>();

        //    matriculaRepoMock.Setup(r => r.Exist(It.IsAny<int>())).Returns(true);
        //    sesionRepoMock.Setup(r => r.Exist(It.IsAny<int>())).Returns(true);
        //    sesionRepoMock.Setup(r => r.EsWebinarPasado(It.IsAny<int>())).Returns(false);
        //    confirmacionRepoMock.Setup(r => r.ObtenerConfirmacionWebinarPorIdMatriculaYIdSesion(It.IsAny<int>(), It.IsAny<int>())).Returns((AsistenciaConfirmacionWebinarDTO)null);
        //    sesionRepoMock.Setup(r => r.ObtenerPorId(It.IsAny<int>())).Returns(new PEspecificoSesion { EsWebinarConfirmado = true });
        //    confirmacionRepoMock.Setup(r => r.Insertar(It.IsAny<AsistenciaConfirmacionWebinarDTO>()));
        //    confirmacionRepoMock.Setup(r => r.Actualizar(It.IsAny<AsistenciaConfirmacionWebinarDTO>()));
        //    _unitOfWorkMock.Setup(u => u.MatriculaCabeceraRepository)
        //               .Returns(matriculaRepoMock.Object);

        //    _unitOfWorkMock.Setup(u => u.PEspecificoSesionRepository)
        //                   .Returns(sesionRepoMock.Object);

        //    _unitOfWorkMock.Setup(u => u.ConfirmacionWebinarRepository)
        //                   .Returns(confirmacionRepoMock.Object);
        //    var dto = new WebinarAlumnoAsistenciaDTO
        //    {
        //        IdMatriculaCabecera = 1,
        //        IdPEspecificoSesion = 1,
        //        EstadoAsistencia = true
        //    };
        //    var result = _service.AsistenciaWebinar(dto);
        //    Assert.IsNotNull((string)result);
        //}
    }
}

namespace BSI.Integra.Aplicacion.DTO.Modelos.IntegraDB
{
    ...
    public class HorarioAsesorSemanaDTO
    {
        public List<TimeSpan?> Lunes { get; set; }
        public List<TimeSpan?> Martes { get; set; }
        public List<TimeSpan?> Miercoles { get; set; }
        public List<TimeSpan?> Jueves { get; set; }
        public List<TimeSpan?> Viernes { get; set; }
        public List<TimeSpan?> Sabado { get; set; }
        public List<TimeSpan?> Domingo { get; set; }
    }

            ...
            foreach (var oportunidad in itemsAgrupadosPorOportunidad)
            {
                ...
                .FirstOrDefault();
                        ...
                        var payload = new
                        {
                            ...
                            brochure,
                            faseOrigen = mapaFases.ContainsKey(item.IdFaseOportunidad_Ant)
                            ? mapaFases[item.IdFaseOportunidad_Ant]
                            : item.IdFaseOportunidad_Ant.ToString(),

                            faseDestino = mapaFases.ContainsKey(item.IdFaseOportunidad)
                            ? mapaFases[item.IdFaseOportunidad]
                            : item.IdFaseOportunidad.ToString()
                        };

...
{
    public class TextEventsDocumentosService : PdfPageEventHelper
    {
        public int contadorPagina = 0;
        public TextEventsDocumentosService(string programa)
        {
        ...
        public override void OnEndPage(PdfWriter writer, Document document)
        {
            ...
            Image jpg2 = Image.GetInstance("https://repositorioweb.blob.core.windows.net/repositorioweb/img/logotiposilabo.png");

            PdfPTable TablaTop = new PdfPTable(3);
            float[] widths = new float[] { 10, 65, 25f };
            TablaTop.SetWidths(widths);

            PdfPCell cellx1 = new PdfPCell(jpg2, true);
            cellx1.Padding = 8f;
            ...
            PdfPCell cellx4 = new PdfPCell(new Phrase("Sílabo-"+nombrePrograma, _FUColumnsNegrita));

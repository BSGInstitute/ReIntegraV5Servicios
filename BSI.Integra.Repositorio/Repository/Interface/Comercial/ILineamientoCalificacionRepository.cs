...
namespace BSI.Integra.Repositorio.Repository.Interface.Comercial
{
    public interface ILineamientoCalificacionRepository : IGenericRepository<TLineamientoCalificacion>
    {
        ...
        (IEnumerable<LlamadaCalificadaRawDTO> Items, int Total) ObtenerReporteVentas(ReporteCalificacionRequest req);
        ...
        (IEnumerable<LlamadaCalificadaRawDTO> Items, int Total) ObtenerReporteFaseVentas(ReporteCalificacionRequest req);

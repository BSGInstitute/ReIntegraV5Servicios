...
{
    public class GestionRemuneracionPuestoTrabajoDetalleRepository : GenericRepository<TPuestoTrabajoRemuneracionDetalle>, IGestionRemuneracionPuestoTrabajoDetalleRepository
    {
        private Mapper _mapper;
        public GestionRemuneracionPuestoTrabajoDetalleRepository(IntegraDBContext context, IConnectionFactory connectionFactory, IDapperRepository dapperRepository) : base(context, connectionFactory, dapperRepository)
        {
            var config = new MapperConfiguration(cfg =>
            {
                cfg.CreateMap<TPuestoTrabajoRemuneracionDetalle, PuestoTrabajoRemuneracionDetalle>(MemberList.None).ReverseMap();
        ...
        #region Metodos Base
        private TPuestoTrabajoRemuneracionDetalle MapeoEntidad(TPuestoTrabajoRemuneracionDetalle entidad)
        {
            try
            {
                TPuestoTrabajoRemuneracionDetalle modelo = _mapper.Map<TPuestoTrabajoRemuneracionDetalle>(entidad);
                return modelo;
            }
            catch (Exception ex)
            {

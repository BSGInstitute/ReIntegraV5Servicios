...
namespace BSI.Integra.Repositorio.Repository.Implementation
{
    ...
    public class AlumnoRepository : GenericRepository<TAlumno>, IAlumnoRepository
    {
        ...
        public AlumnoAccesosDTO ObtenerAccesosAlumno(int idAlumno)
        {
            try
            {
                string _queryDatosAlumno = @"SELECT Id, UserName as usuario,Clave as contrasenia FROM [40.76.216.5].integraDB_PortalWeb.dbo.AspNetUsers WHERE IdAlumno=@idAlumno";
        ...
        public AvatarAlumnoDTO ObtenerAvatar(int IdAlumno, string Genero)
        {
            try
            {
                ...
                _query = "SELECT IdAvatar,IdALumno,TopC, Accessories, Hair_Color, Facial_Hair, Facial_Hair_Color, Clothes, Clothes_Color,Eyes,Eyesbrow,Mouth,Skin FROM [40.76.216.5].integraDB_PortalWeb.dbo.V_PW_ObtenerAvatar WHERE IdAlumno = @IdAlumno";
